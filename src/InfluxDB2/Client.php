...
class Client
{
     ...
     * @return WriteApi
     */
    public function createGuzzleWriteApi(array $writeOptions = null, array $pointSettings = null): WriteApi
    {
     ...
     * @return QueryApi
     */
    public function createGuzzleQueryApi(): QueryApi
    {
     ...
     * @return HealthCheck
     */
    public function guzzleHealth(): HealthCheck
    {
     ...
     * @return object service instance
     */
    public function createGuzzleService($serviceClass)
    {
        try {
